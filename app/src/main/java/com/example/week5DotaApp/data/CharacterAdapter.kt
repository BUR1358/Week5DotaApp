...
import com.example.week5DotaApp.MainActivity
import com.example.week8dotafragmentsappwb.R
import com.example.week5DotaApp.fragments.CharacterInfoFragment
import com.example.week5DotaApp.model.CharacterItem
import java.util.*
    ...
    override fun onBindViewHolder(holder: CharacterViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val characterInfoBundle = Bundle().apply {
                ...
                putString(
                    Utils.PRIMARY_ATTRIBUTE_KEY,
                    characterItem.primaryAttribute.uppercase(Locale.getDefault())
                )
